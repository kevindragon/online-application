...
urlpatterns = patterns('',
    ...
    url(r'^management/elementary/$', 'app.views.elementary'), 
    url(r'^management/elementary/search/$', 'app.views.elementary'), 
    ...
    url(r'^management/reviewed/$', 'app.views.m_reviewed'), 
    url(r'^management/reviewed/search/$', 'app.views.m_reviewed'), 
    url(r'^management/people/(?P<people_id>\d+)', 'app.views.m_people'), 
    url(r'^management/notpass/$', 'app.views.m_notpass'), 
    url(r'^management/unqualified/$', 'app.views.m_unqualified'), 
